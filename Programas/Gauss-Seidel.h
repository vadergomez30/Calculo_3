...
bool detener2(const vector<double> &x_ant, const vector<double> &x_nue, const double &error){
...
void iterativoGaussSeidel(const Mat&A, const vector<double>&b, vector<double>&x_ant, vector<double>&x_nue, const double error, int &count){
